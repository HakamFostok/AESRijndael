...
public class TextViewModel : BaseViewModel
{
    ...
    private void FormatTextEventHandler() => throw new NotImplementedException();

    private void AlgorithmKindChangedEventHandler(AesKeyBase algorithmType) => _algorithmType = algorithmType;
