...
public partial class FrmAesRijndael : Form
{
    ...
    private void LoadLanguageOnForm(Language lang)
    {
        ...
        foreach (Control container in this.Controls.OfType<GroupBox>())
        {
            ...
            {
                if (control is Label or RadioButton or Button)
                {
                    setText(control);
                }
            }
    ...
    private void btnAbout_Click(object sender, EventArgs e) => new AboutFrm().ShowDialog();
    ...
    private void rdbtnEncrpyt_CheckedChanged(object sender, EventArgs e) => SetRichTextReadOnlyStatu((RadioButton)sender, richtxtCipher, richtxtPlain);

    private void rdbtnDecrypt_CheckedChanged(object sender, EventArgs e) => SetRichTextReadOnlyStatu((RadioButton)sender, richtxtPlain, richtxtCipher);
    ...
    private void FrmAesRijndael_FormClosing(object sender, FormClosingEventArgs e) => currentSettings.Save();
